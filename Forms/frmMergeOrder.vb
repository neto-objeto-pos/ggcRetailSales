...
Public Class frmMergeOrder
    Private Const pxeMaxTable As Integer = 70
...
endProc:
    ...
    Private Sub markTable(ByVal fsTables As String, ByVal fsStatus As xeTableStatus)
        ...
        Select Case fsStatus
            ...
            Case xeTableStatus.xeOccupied
                If poMerge.getTerminal(fsTables + 1) = p_sTerminal Then
    ...
    Private Sub showGroup(ByVal fnTableNox As String, ByVal fnIndex As Integer)
        Dim loDT As DataTable
...
endProc:
    ...
    Private Sub lblTable_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim loLbl As Label
